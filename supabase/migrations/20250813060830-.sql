-- Fix the profiles table foreign key constraint and create demo users properly
...
-- Now let's create the demo users directly by inserting into both auth and public tables
...
BEGIN
    ...
    ('CASE-2024-002', 'Employment Law Consultation', 'Workplace harassment and wrongful termination case', client_id, lawyer_id, 'in_progress', CURRENT_DATE - INTERVAL '15 days', 8500.00, now(), now())
